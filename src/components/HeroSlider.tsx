...
const slides = [
  {
    ...
    description: "Journey through the rich tapestry of African heritage and discover the profound wisdom that has guided generations.",
  ...
  },
  {
    ...
    description: "Connect children to the magnificent legacy of African civilizations through engaging stories and interactive learning.",
    cta: "Start Learning"
  },
  {
    id: 3,
    ...
    description: "Experience the power of storytelling as we share the values and traditions that build strong character and community.",
  ...
  },
  {
    ...
    description: "Innovative approaches to learning that honor our past while preparing children for a bright future.",
              ...
              <div className="max-w-3xl">
                ...
                >
                  ...
                  <Button 
                    variant="hero" 
                    size="lg"
                    className="font-ubuntu text-lg px-8 py-4"
                  >
                    {slide.cta}
                  </Button>
                </div>
