      ...
      <div className="container mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground font-ubuntu leading-relaxed mb-6">
              Empowering the next generation with African ancient wisdom and cultural heritage. 
              Building global citizens rooted in their identity and values.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground font-ubuntu">info@bokobokids.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-primary" />
                <span className="text-muted-foreground font-ubuntu">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-primary" />
                <span className="text-muted-foreground font-ubuntu">Global Community</span>
              </div>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
              ...
              <p className="text-sm text-muted-foreground mb-4 font-ubuntu">
                Get updates on cultural events, new resources, and community stories.
              </p>
              <div className="space-y-3">
                ...
                />
                <Button variant="heritage" size="sm" className="w-full font-ubuntu">
                  Subscribe
                </Button>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex items-center space-x-2 text-muted-foreground font-ubuntu">
            <span>© 2024 Bokobokids Village. Made with</span>
            <Heart className="w-4 h-4 text-red-500 animate-pulse" />
            <span>for global citizens.</span>
          </div>
          
          <div className="flex space-x-6 text-sm">
            <a href="#" className="text-muted-foreground hover:text-primary transition-colors duration-300 font-ubuntu">
              Privacy Policy
            </a>
            <a href="#" className="text-muted-foreground hover:text-primary transition-colors duration-300 font-ubuntu">
              Terms of Service
